...
import RegisterSentence from './components/RegisterSentence';
...
function PlayAudioTraining() {
    ...
    const openAudio = (rep) => {
        console.log("scene :" + specificScene[0].play_name);
        rep.scene = specificScene[0].play_name
        // console.log(pl)
        setReplique(rep);
        setShowAudio(true)
    }
            ...
            <div>
                ...
                <div className='flex justify-center mt-5 flex-wrap' >
                    ...
                    {characters.map((el, index) => (<>
                        {(el != null && el != "Indication") && <button onClick={() => (setCharacterPlay(el), allSee())} key={index} className='text-red-100 bg-red-700 rounded-lg m-2 p-2'>{el}</button>}
                    </>))}
        ...
        {(characterPlay != '' && scene != "") &&
            <div>
                ...
                <div className='w-full flex justify-center'>
                    ...
                    {!boolSeeAll &&
                        <div onClick={()=>onTraining()} className='bg-red-800 flex flex-col justify-center p-4 text-white rounded-full'>
                            <button className='text-[35px] mx-auto text-center text-white ' >
                                <FaEye />
                            </button>
                            <p className='text-sm'>
...
export default PlayAudioTraining;